...
var encodedData = require('soop').load('parkbytecore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('parkbytecore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('parkbytecore/lib/Address', {
